...
import { ArweaveSigner, DataItem } from "./index";
...
export async function sign(item: DataItem, signer: ArweaveSigner): Promise<Buffer> {
...
export async function getSignatureAndId(
    ...
    const valid = await ArweaveSigner.verify(signer.pk, signatureData, signatureBytes)
